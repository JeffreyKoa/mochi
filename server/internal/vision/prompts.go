...
仅输出 JSON，无其他文字：
{"user_expression":"neutral|tired|sad|happy|anxious|thinking|hesitant|unknown","confidence":0.0,"note":"Mochi 第一人称中文"}`, userText, expr, note)
}
...
仅输出 JSON，无其他文字：
{"user_expression":"neutral|tired|sad|happy|anxious|thinking|hesitant|unknown","confidence":0.0,"note":"Mochi 第一人称中文"}`
	case FocusObject:
