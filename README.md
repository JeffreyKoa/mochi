...
跨平台 AI 生命伙伴 MVP：Windows 桌宠 + Go 单体后端 + 记忆 + 生命引擎 + **语音聊天**。

**产品总目标**：Mochi 是你的知心朋友（陪伴与情绪价值），也是生活帮手（提醒 / 待办 / 搜索 / 定时）、内容老师（英语 / 为人处世）与学习教练（教你怎么学）——同一只 Mochi，四种角色自然延伸。详见 [`docs/AI-Life-实施方案-V1.0.md`](docs/AI-Life-实施方案-V1.0.md) 第一章。
